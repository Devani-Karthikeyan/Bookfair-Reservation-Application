package com.project.BookfairReservationApp.config;

import com.project.BookfairReservationApp.util.JwtAuthenticationFilterUtil;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/stalls/**").hasAnyRole("EMPLOYEE", "VENDOR")
                        .requestMatchers("/api/halls/**").hasAnyRole("EMPLOYEE")
